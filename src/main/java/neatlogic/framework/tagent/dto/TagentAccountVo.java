...
public class TagentAccountVo extends BaseEditorVo {
    ...
    public TagentAccountVo() {
    }

    public TagentAccountVo(String name, Long protocolId, Integer protocolPort, String ip, String passwordPlain) {
        this.name = name;
